...
public class ClassificationDemoAppTearDownFixture extends FixtureScript {
    ...
    protected void execute(final ExecutionContext executionContext) {
        isisJdoSupport.executeUpdate("delete from \"classificationdemo\".\"ClassificationForDemoObject\"");
        isisJdoSupport.executeUpdate("delete from \"classificationdemo\".\"DemoObject\"");
